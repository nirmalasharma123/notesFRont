...
const Home = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const data = await axios.post("https://backendnotess.onrender.com/createNote", {
        title,
        description
      }, {
  ...
  const deleteNote = async (noteId) => {
    try {
      await axios.delete(`https://backendnotess.onrender.com/deleteNote/${noteId}`, {
        headers: { 'x-api-key': localStorage.getItem('token') }
      });
  ...
  const handleSaveEdit = async (noteId) => {
    try {
      ...
      await axios.put(`https://backendnotess.onrender.com/updateNotes/${noteId}`, editedNote, {
        headers: { 'x-api-key': localStorage.getItem('token') }
      });
      setEditNoteId(null);
  ...
  const fetchNotes = async () => {
    try {
      ...
      const response = await axios.get("https://backendnotess.onrender.com/getNotes", {
